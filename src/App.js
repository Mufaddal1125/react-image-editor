      ...
      <div className="main-image">
        <Stage width={window.innerWidth} height={window.innerHeight}>
          <Layer className="image-parent">
            <URLImage className="image" noise={options[5].value / 1} posterize={options[4].value / 1} pixel={options[2].value / 1} luminance={options[3].value / 1} contrast={options[1].value / 1} brightness={options[0].value / 10} Blur={options[6].value} src={src}></URLImage>
          </Layer>
        </Stage>
      </div>
